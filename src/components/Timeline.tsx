  ...
  return (
    <div className="flex items-start gap-4 relative ">
      ...
      <div className="flex flex-col gap-2 max-w-[1000px] shadow-sm rounded-2xl p-4 bg-[var(--bg-light)] dark:bg-[var(--bg-dark)] 
        ...
        <div className="text-base leading-7 md:text-lg md:leading-8 pl-1 text-gray-700 dark:text-gray-300 mt-2">
          <p>
            {description}
          </p>
        </div>
        ...
        <div>
          <ul className="list-disc pl-6 space-y-2 text-base leading-7 md:text-lg md:leading-8 text-gray-700 dark:text-gray-300">
